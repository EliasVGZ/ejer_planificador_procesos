...
public class Mayúsculas {
    ...
    public static void main(String[] args) {
       ...
       // segundo argumento con la especificación en disco del fichero  de salida a crear.
        File fichero = new File("src\\ejecutables\\cadenas.txt"); //utilizamos aquí segundo argumento recibido
        FileWriter fw = null;

        try {
            Process hijo = new ProcessBuilder("src\\ejecutables\\mayusculashijo.exe").start(); //aquí utilizamos primer argumento recibido
